...
1) **ES**: локальний шлях до файлу електронного підпису (.jks, .pfx, .pk8, .zs2, .dat)
2) **PASSWORD**: пароль до електронного підпису
3) **PHONE**: український номер телефону
3) **EMAIL**: пошта, на яку прийде талон
